...
export async function hydratePage() {
	...
	hydrateOnClick(appState, setCookie);

	// here we determine if an element should be deleted form the DOM via the d-if directive
	hydrateIfAttributes(appState);

	hydratePointerEnter(appState);

	hydratePointerExit(appState);

	hydrateMouseDown(appState);

	hydrateMouseUp(appState);
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function hydrateOnClick(appState: Reactive, setCookie: CallableFunction) {
	const documentBody = document.getElementById('app');
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function hydratePointerEnter(appState: Reactive) {
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function hydratePointerExit(appState: Reactive) {
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function hydrateMouseDown(appState: Reactive) {
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function hydrateMouseUp(appState: Reactive) {
